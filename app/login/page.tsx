        ...
        >
          {SLIDES.map((slide, i) => (
            <div key={i} className="w-full shrink-0 flex flex-col items-center px-6">
              {/* Super Size Vector Icon Container */}
              <div className="w-[180px] h-[180px] sm:w-[200px] sm:h-[200px] rounded-[3rem] bg-primary/5 flex items-center justify-center ring-4 ring-primary/10 shadow-inner mb-8 mt-4 mx-auto overflow-hidden relative">
                <div className="absolute inset-0 bg-linear-to-tr from-primary/10 via-transparent to-transparent pointer-events-none" />
                <slide.icon className="w-20 h-20 sm:w-24 sm:h-24 text-primary relative z-10 drop-shadow-sm" strokeWidth={1.5} />
              </div>
...
function InteractiveSpotlight() {
  ...
  return (
    <div 
      className="absolute inset-0 bg-isimova-blue overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-tr from-isimova-blue via-transparent to-primary/5 pointer-events-none" />
    </div>
  )
}

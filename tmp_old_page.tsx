      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-extrabold text-on-surface tracking-tight">
            Bienvenido, {profile?.full_name?.split(' ')[0]} ­ƒæï
          </h1>
          <p className="text-on-surface-variant mt-2 text-lg font-light">Contin├║a tu aprendizaje donde lo dejaste.</p>
        </div>
        ...
        {(!enrollments || enrollments.length === 0) ? (
          <div className="text-center py-20 text-on-surface-variant">
            ...
            <p className="text-xl font-light">No tienes cursos matriculados a├║n.</p>
          </div>
        ) : (
